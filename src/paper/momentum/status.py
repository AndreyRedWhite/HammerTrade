"""Build and write Momentum Continuation paper trader status JSON."""
import json
from datetime import datetime, timezone
from pathlib import Path
from typing import Optional

from src.paper.momentum.models import MomentumDailyContext, MomentumPaperTrade


def build_momentum_status(
    ticker: str,
    experiment_name: str,
    direction: str,
    signal_params: dict,
    ...
    """Build Momentum status dict. Compute liveness using compute_liveness()."""
    ...
    if open_trade is not None:
        open_trade_dict = {
            ...
            "atr_value": open_trade.atr_value,
            "candle_range": open_trade.candle_range,
        }
    ...
    return {
        ...
        "daily_state": {
            ...
            "trades_today": daily_ctx.trades_today,
...
def write_momentum_status(status: dict, path: str) -> None:
